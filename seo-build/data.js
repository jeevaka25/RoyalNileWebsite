...
const TOURS = [
  {
    ...
    overview: 'Experience the total solar eclipse on 2 August 2027 from a premium West Bank base at Royal Nile Villas. The package requires a minimum four-night accommodation booking and includes three meals per day, bottled water, soft drinks, and private Luxor Airport pickup and drop-off. The property offers completely unobstructed panoramic views across the Nile and open sky, making it an exceptional base for eclipse viewing. Optional private tours can be added around the event, while the sunrise balloon flight operates as a shared experience. A non-refundable 25% deposit is required to hold the booking; your written quotation will confirm the remaining balance schedule and cancellation terms.',
    highlights: [
      ...
      'Non-refundable 25% deposit required to hold the booking',
    ],
    ...
    depositNote: 'A non-refundable 25% deposit is required to hold the booking.',
    faqs: [
      ...
      ['How much does the 2027 eclipse package cost?', 'Pricing depends on dates, party size, apartment choice and requested extras. Contact us on WhatsApp for availability and a confirmed price. A non-refundable 25% deposit is required to hold the booking; your written quotation will state the remaining balance schedule and cancellation terms.'],
      ['What deposit is required to hold an eclipse booking?', 'A non-refundable 25% deposit is required to hold the Royal Nile Villas eclipse booking. Availability is not secured until the deposit has been received and the booking is confirmed in writing. Your quotation will state the remaining balance schedule and cancellation terms.'],
...
const VILLAS = [
  { id:'royal-home-nile-view', name:'Royal Home Luxor — Nile View', location:'West Bank, Luxor', guests:4, bedrooms:2, beds:2, bathrooms:1, rating:4.91, reviews:404, floor:'Top Floor', viewType:'Nile, Pool & Garden', bedsConfig:'2 Queen Beds',
    ...
    airbnbUrl:'https://www.airbnb.co.uk/rooms/33825380', bookingUrl:'https://www.booking.com/hotel/eg/royal-home-luxor-nile-view-luxor.en-gb.html',
  ...
  { id:'nile-view-1', name:'Royal Nile Villa — Nile View Apartment 1', location:'Al Aqaletah, West Bank', guests:4, bedrooms:2, beds:3, bathrooms:1, rating:4.90, reviews:58, floor:'Ground Floor', viewType:'Nile, Garden & Mountain', bedsConfig:'1 Queen + 2 Singles',
    ...
    airbnbUrl:'https://www.airbnb.co.uk/rooms/950750256318960064', bookingUrl:'https://www.booking.com/hotel/eg/royal-nile-villas-pool-view-apartment-1.en-gb.html',
  ...
  { id:'nile-view-2', name:'Royal Nile Villas — Nile View Apartment 2', location:'Al Aqaletah, West Bank', guests:4, bedrooms:2, beds:3, bathrooms:1, rating:4.91, reviews:58, floor:'Ground Floor', viewType:'Nile & Desert View', bedsConfig:'1 Queen + 2 Singles',
    ...
    airbnbUrl:'https://www.airbnb.co.uk/rooms/952260705771172731', bookingUrl:'https://www.booking.com/hotel/eg/royal-nile-villas-pool-view-apartment-2.en-gb.html',
